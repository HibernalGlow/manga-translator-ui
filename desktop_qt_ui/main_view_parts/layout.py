...
def create_translation_page(self) -> QWidget:
    ...
    self.add_files_by_path_button = QPushButton(self._t("Add by Path"))
    self.add_files_from_clipboard_button = QPushButton(self._t("From Clipboard"))
    ...
    self.add_files_by_path_button.setProperty("chipButton", True)
    self.add_files_from_clipboard_button.setProperty("chipButton", True)
    ...
    file_buttons_layout.addWidget(self.add_files_by_path_button)
    file_buttons_layout.addWidget(self.add_files_from_clipboard_button)
    ...
    self.add_files_by_path_button.clicked.connect(self._trigger_add_files_by_path)
    self.add_files_from_clipboard_button.clicked.connect(self._trigger_add_files_from_clipboard)
